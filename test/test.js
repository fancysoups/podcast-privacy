...
const podcastHostInfo = require('../index.js');

describe('PodcastHostInfo', function () {
  describe('Example URL #1', function () {
    const data = podcastHostInfo(
  ...
  describe('Example URL #3 (Unknown)', function () {
    const data = podcastHostInfo('https://example.com');
  ...
  describe('Missing URL', function () {
    it('should throw an error', function () {
      assert.throws(() => podcastHostInfo(), Error);
    });
  });
  describe('Invalid URL type', function () {
    it('should throw an error', function () {
      assert.throws(() => podcastHostInfo(12345), Error);
    });
  });
});
